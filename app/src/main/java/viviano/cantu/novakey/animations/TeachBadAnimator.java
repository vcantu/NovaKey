 ...
 */
public class TeachBadAnimator extends BaseAnimation {

    private String command;

    public TeachBadAnimator(String command) {
    ...
    public ValueAnimator animateChar(final char c, long betweenDelay) {
        Keyboard kl = Controller.currKeyboard;
    ...
    private class Fing implements MainView.Drawer {
        public float x, y;
        public float r;
        public Paint p;
