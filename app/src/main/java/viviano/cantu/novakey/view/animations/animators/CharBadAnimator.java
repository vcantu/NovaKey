...
import viviano.cantu.novakey.view.animations.DelayableInterpolator;
 ...
 */
public abstract class CharBadAnimator extends BadAnimator {
    ...
    public CharBadAnimator(int style) {
        this(style, 500);
    }

    public CharBadAnimator(int style, long duration) {
        this.style = style;
